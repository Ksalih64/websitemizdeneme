...
MINERALS = [
    ...
    product("lead", "lead-ore.jpg", "Pb", t("Bleierz", "Lead ore", "Kurşun cevheri"), t("Erz / Konzentrat", "Ore / concentrate", "Cevher / konsantre"), t("Bulk oder Big Bag", "Bulk or Big Bag", "Bulk veya Big Bag"), t("Batterien, Metallurgie, Industrie", "Batteries, metallurgy, industry", "Batarya, metalurji, sanayi"), t("Bleierz", "Lead Ore", "Kurşun Cevheri"), t("Bleierz und Bleikonzentrat für Metallurgie, Batterieindustrie und Weiterverarbeitung mit klarer Dokumentation der Analysewerte.", "Lead ore and lead concentrate for metallurgy, battery production and downstream processing with clear analytical documentation.", "Metalurji, batarya üretimi ve ileri işleme için kurşun cevheri/konsantresi; analiz değerleri açık şekilde belgelenir.")),
    product("zinc", "zinc-ore.jpg", "Zn", t("Zinkerz", "Zinc ore", "Çinko cevheri"), t("Erz / Konzentrat", "Ore / concentrate", "Cevher / konsantre"), t("Bulk oder Big Bag", "Bulk or Big Bag", "Bulk veya Big Bag"), t("Verzinkung, Legierungen, Metallurgie", "Galvanizing, alloys, metallurgy", "Galvanizleme, alaşım, metalurji"), t("Zinkerz", "Zinc Ore", "Çinko Cevheri"), t("Zinkerz und Zinkkonzentrat für Verzinkung, Legierungen, Metallurgie und industrielle Rohstoffversorgung; Analysebericht und Herkunftsdokumente sind auf Anfrage verfügbar.", "Zinc ore and zinc concentrate for galvanizing, alloys, metallurgy and industrial raw material supply, with assay and origin documents available on request.", "Galvanizleme, alaşım, metalurji ve endüstriyel hammadde tedariki için çinko cevheri/konsantresi; analiz raporu ve menşe belgeleri talep üzerine paylaşılır.")),
